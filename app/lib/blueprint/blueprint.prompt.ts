...
export function buildBlueprintPrompt(params: {
  ...
  return {
    ...
    developer: [
      ...
      "",
      "OUTPUT SIZE LIMITS (very important):",
      "- executive_summary.one_liner max 180 characters.",
      "- hero.structure.subheadline max 220 characters.",
      "- homepage_sections: exactly 6 sections.",
      "- each homepage section: 2–4 copy_blocks only.",
      "- paragraph copy_blocks: max 280 characters each.",
      "- bullets: 3–5 bullets max.",
      "- seo_plan.pages: 5–7 pages only.",
      "- outline_h2: 4–6 items per page.",
      "- messaging_pillars: exactly 3 pillars.",
      "- ai_prompt_library: exactly 4 prompts (not more).",
      "",
      "HOMEPAGE SECTIONS:",
